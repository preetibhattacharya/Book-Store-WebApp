...
const Signup = () => {
  ...
  const handleRegister=()=>{
   ...
   return (
    <form onSubmit={handleSignUp} className="container max-w-md mx-auto mt-10 p-6 bg-white rounded shadow-md">
      <div className="header text-center">
        <div className="text font-bold text-5xl">Sign Up</div>
      ...
      <button onClick={handleRegister} className="google flex items-center justify-center bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
        <FaGoogle className="w-4 mr-2" /> Sign In With Google
      </button>
    </form>
  );
};
