...
const Banner = () => {
  return (
    <div className='px-4 lg:px-24 bg-violet-200 flex flex-col md:flex-row items-center'>
        <div className='flex w-col flex-col md:flex-row justify-between items-center gap-6 py-36'>
            <div className='md:w-4/5 space-y-8 h-full'>
                <h2 className="text-5xl font-bold text-black leading-snug">Buy and Sell Books <span className='text-violet-600'>at Best Prices</span></h2>
